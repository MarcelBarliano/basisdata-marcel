...
class DosenController extends Controller
{
    ...
    {
        $koneksi = DB::connection("mysql")->table("dosen")->get();
    ...
    public function create(Request $request)
    {
        ...
        $koneksi = DB::connection("mysql")->table("dosen")->insert($request->all());
    ...
    {
        $koneksi = DB::connection("mysql")->table("dosen")->find($id);
        if ($koneksi == NULL){
    ...
    {
        $koneksi = DB::connection("mysql")->table("dosen")->where("id",$id)->get();
    ...
    public function destroy($id)
    {
        ...
        if ($koneksi == NULL){
            ...
            $koneksi = DB::connection("mysql")->table("dosen");
            $koneksi->find($id);
            $koneksi->delete($id);
